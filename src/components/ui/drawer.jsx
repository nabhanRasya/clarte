  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-background fixed z-50 flex h-auto flex-col items-start justify-center px-6",
...
function DrawerHeader({ className, ...props }) {
  return (
    <div
      ...
      className={cn(
        "flex flex-col gap-0.5 p-4 group-data-[vaul-drawer-direction=bottom]/drawer-content:text-start group-data-[vaul-drawer-direction=top]/drawer-content:text-start md:gap-1.5 md:text-left",
        className
      )}
      {...props}
    />
